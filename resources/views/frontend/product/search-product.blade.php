                        ...
                        <div class="widget_list widget_categories">
                            ...
                            <ul>
                                @foreach($categories as $category)
                                    <li>
                                        <a href="{{ route('menu',['id'=>$category->id,'name'=>$category->category_name])}}">{{ $category->category_name  }}</a>
                                    </li>
                                @endforeach
                                ...
                                @foreach($topRatedProducts as $topRatedProduct)
                                    <div class="recent_product_list">
                                        <div class="recent_product_thumb">
                                            <a href="{{ route('product-details',['id'=>$topRatedProduct->id,'slug'=>$topRatedProduct->slug]) }}"><img src="{{ asset($topRatedProduct->main_image) }}" alt=""></a>
                                        </div>
                                        <div class="recent_product_content">
                                            <h3><a href="{{ route('product-details',['id'=>$topRatedProduct->id,'slug'=>$topRatedProduct->slug]) }}">{{$topRatedProduct->product_name }}</a></h3>
                            ...
                            <div class=" col-lg-3 col-md-4 col-sm-6">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="{{ route('product-details',['id'=>$product->id,'slug'=>$product->slug]) }}"><img src="{{ asset($product->main_image) }}" alt="" ></a>
                                            ...
                                            <ul>
                                                <li class="wishlist">
                                                    <form  action="{{ route('new-wish-list') }}" method="post" style="display: inline">
                                                        ...
                                                        <button type="submit" style="border: none;background: none"><a title="Add to Wishlist"><i class="fa fa-heart-o" aria-hidden="true"></i></a></button>
                                                    </form>
                                                </li>
                                                <li class="add_to_cart">
                                                    <form  action="{{ route('cart-add') }}" method="post" style="display: inline">
                                                        @csrf
                                                        <input type="hidden" value="{{ $product->id }}" name="Product_id">
                                                        <button type="submit" style="border: none;background: none"><a title="add to cart"><i class="zmdi zmdi-shopping-cart-plus"></i> add to cart</a></button>
                                                    </form>
                                                </li>
