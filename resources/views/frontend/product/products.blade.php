...
{{--                            @if(Request::is($url))--}}
                            <form action="{{ route('price-filter') }}" method="post" enctype="multipart/form-data">
                                ...
                                <input type="text" name="price_min" placeholder="{{ $price_min }}" value="" style="width: 133px;"/>
                                <input type="text" name="price_max" placeholder="{{ $price_max }}" value="" style="width: 133px;"/><br><br>
                                ...
                                <div class="product_thumb">
                                    ...
                                    <div class="label_product">
                                        @if($product->product_stock<=0)
                                            <span class="label_sale">stock out</span>
                                        @endif
                                    </div>
                                ...
                                <div class="product_content grid_content">
                                    ...
                                    <div class="action_links">
                                        <ul>
                                            ...
                                            <li class="compare"><a href="{{ route('product-details',['id'=>$product->id]) }}" title="compare"><i class="zmdi zmdi-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
