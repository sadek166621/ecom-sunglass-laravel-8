                        ...
                        <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                            ...
                            @foreach($categories as $category)
                                ...
                                <tr>
                                    ...
                                    <td>{{$category->special_category==1 ? 'Show':'Hide'}}</td>
                ...
                <div class="modal-body">
                    <form action="{{ route('new-category') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" name="special_category" value="1" checked> Show  	&nbsp; 	&nbsp; 	&nbsp;
                            <input type="radio" name="special_category" value="0"> Hide<br>
                        </div>
                        <div class="form-group">
