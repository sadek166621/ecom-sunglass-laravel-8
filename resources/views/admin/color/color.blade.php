...
{{--                                <th>Action</th>--}}
                            ...
                            @foreach($colors as $color)
                                ...
                                <tr>
                                    <td>{{$i}}</td>
                                    <td>{{substr($color->color_name,0,30)}}</td>
                                    <td><span style="background: {{$color->color_code}}; padding: 5px 20px;color: #fff">{{$color->color_code}}</span>
                                    </td>
                                    <td>{{$color->publication_status==1 ? 'Published':'Unpublished'}}</td>
{{--                                    <td>--}}
                ...
                <div class="modal-body">
                    <form action="{{ route('color.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="color_name" id="" placeholder="" required>
                        </div>
                        <div class="form-group">
                            <label for="">Color Code</label>
                            <input type="text" class="form-control" name="color_code" value="#" id="" placeholder="" required>
                        </div>
                        <div class="form-group">
