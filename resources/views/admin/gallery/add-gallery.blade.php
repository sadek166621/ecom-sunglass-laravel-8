                        ...
                        <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                            ...
                            @foreach($gallery as $gallery)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($gallery->section_1==1)
                                            {{ 'Section 1' }}
                                            @elseif($gallery->section_2==1)
                                            {{ 'Section 2' }}
                                            @elseif($gallery->section_3==1)
                                            {{ 'Section 3' }}
                                            @elseif($gallery->section_4==1)
                                            {{ 'Section 4' }}
                                            @elseif($gallery->section_5==1)
                                            {{ 'Section 5' }}
                                            @elseif($gallery->section_6==1)
                                            {{ 'Section 6' }}
                                        @endif
                                    </td>
                    ...
                    <form class="form-horizontal" action="{{ route('new-gallery') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="third_header" id="" placeholder="">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 col-sm-offset-3">
                                    ...
                                    <label>section 3:</label><input type="radio" name="section" value="3" >
                                    <label>section 4:</label><input type="radio" name="section" value="4" >
                                    <label>section 5:</label><input type="radio" name="section" value="5" >
                                    <label>section 6:</label><input type="radio" name="section" value="6" >
                                </div>
                            </div>
