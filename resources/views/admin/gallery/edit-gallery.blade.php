                ...
                <div class="panel-content">
                    <form name="editForm" class="form-horizontal" action="{{ route('update-gallery') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="">First heading</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="first_header" value="{{ $gallery->first_header }}" id="" placeholder="">
                                </div>

                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="">Last heading</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="last_header" value="{{ $gallery->last_header }}" id="" placeholder="">

                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="">Third heading</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="third_header" value="{{ $gallery->third_header }}" id="" placeholder="">
                                </div>
                            ...
                            <label for="publicationStatus" class="col-sm-4 control-label">section</label>
                            <div class="form-group">
                                <div class="col-sm-6 col-sm-offset-3">
                                    ...
                                    <label>section 3:</label><input type="radio" name="section" value="3" {{ $gallery->section==3? 'checked' : ''}}>
                                    <label>section 4:</label><input type="radio" name="section" value="4" {{ $gallery->section==4? 'checked' : ''}}>
                                    <label>section 5:</label><input type="radio" name="section" value="5" {{ $gallery->section==5? 'checked' : ''}}>
                                    <label>section 6:</label><input type="radio" name="section" value="6" {{ $gallery->section==6? 'checked' : ''}}>
                                </div>
                            </div>
                        <div class="form-group">
