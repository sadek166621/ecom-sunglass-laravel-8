            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="panel widgetbox wbox-2 bg-scale-0">
                        <a href="{{ route('free-shipping',['id'=>$freeShipping->first()->id]) }}">
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        <h4 class="subtitle color-darker-1">Free Shipping</h4>
                                        <h1 class="title color-primary"> {{ $freeShipping->first()->free_shipping ? 'ON': 'OFF' }}</h1>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="#">
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        <h4 class="subtitle color-lighter-1">Total Visitor</h4>
