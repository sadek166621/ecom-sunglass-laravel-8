...
@section('content')
        ...
        <div class="col-sm-12">
            ...
            <div class="panel">
                <div class="panel-content">
                    <form  name="editForm" class="form-horizontal" action="{{ route('blog.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="header" value="{{ $blog->header }}" id="" placeholder="Blog Title">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="slug" value="{{ $blog->slug }}" id="" placeholder="Blog Url">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Description</label>
                            <div class="col-sm-10">
                                <textarea type="text" class="form-control summernote" name="description" id="" placeholder=" Description">{!! $blog->description !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img id="img" src="{{ asset( $blog->image) }}" alt="" style="height: 50px; width: 50px">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Author</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="author" value="{{ $blog->author }}" id="" placeholder="author">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="radio" name="publication_status" value="0" {{$blog->publication_status==0 ? 'checked':''}}> UnPublished<br>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script>
        document.forms['editForm'].elements['blog_category_id'].value = '{{ $blog->blog_category_id }}';
    </script>
@endsection
